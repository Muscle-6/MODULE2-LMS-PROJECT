...
public class LectureController {
    ...
    @GetMapping("/instructor/courses/{courseId}/lectures/{lectureId}/watch")
    public ModelAndView instructorWatchLecture(ModelAndView mv,
        ...
        mv.setViewName("lecture/instructor-watch");
